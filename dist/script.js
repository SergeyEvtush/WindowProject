...
var images = function images() {
  ...
  workSection.addEventListener('click', function (e) {
    ...
    if (target && target.classList.contains('preview')) {
      ...
      var path = target.parentNode.getAttribute('href'); //href="assets/img/our_works/big_img/1.png"
...
var modals = function modals() {
  ...
  bindModal('.popup_engineer_btn', '.popup_engineer', '.popup_engineer .popup_close'); //phone_link
...
var timer = function timer(id, deadLine) {
  ...
  var setDate = function setDate(date) {
    var bannerDate = document.querySelector('.sale_subtitle');
    var month = '';
    var memberArray = date.split("-");
    var monthNames = {
      "01": "января",
      "02": "февраля",
      "03": "марта",
    ...
    for (var key in monthNames) {
      if (Object.hasOwnProperty.call(monthNames, key) && key == memberArray[1]) {
        month = monthNames[key];
      }
    }

    var dayName = memberArray[2].split('');
    bannerDate.textContent = "\u0423\u0441\u043F\u0435\u0439 \u0441\u044D\u043A\u043E\u043D\u043E\u043C\u0438\u0442\u044C \u043D\u0430 \u043E\u0441\u0442\u0435\u043A\u043B\u0435\u043D\u0438\u0438! \u0422\u043E\u043B\u044C\u043A\u043E \u0434\u043E ".concat(dayName[0] == 0 ? dayName[1] : memberArray[2], " ").concat(month);
  };
